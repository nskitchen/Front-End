  ...
  return (
    ...
    >
      <g
        ...
        strokeWidth={2}
      >
        <path d="m15 15l3.379-3.379a2.121 2.121 0 0 1 1.5-.621H20a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2h4.515a6 6 0 0 1 4.242 1.757zM3 15h18v2a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3z"></path>
        <path d="M12 4c-4.623 0-8.432 1.756-8.942 6c-.066.55.39 1 .942 1h16c.552 0 1.008-.45.942-1c-.51-4.244-4.319-6-8.942-6M7.001 8H7m5.002 0"></path>
      </g>
    </svg>
  );
}
...
export function Sandwich(props) {
  return (
    ...
    >
      <path
        fill="black"
        d="m28.1 9.67l-11.07-6.4c-.64-.36-1.42-.36-2.06.01L3.91 9.67a.951.951 0 0 0-.464.95H3.43v2.54c0 .215.072.43.216.602c-.921.552-1.593 1.544-1.616 2.978c.021 1.316.591 2.26 1.4 2.833v2.037c0 .32.16.64.48.82l11.07 6.4c.63.37 1.42.37 2.05 0l11.07-6.4c.32-.18.48-.5.48-.82v-2.033c.81-.572 1.384-1.518 1.41-2.837c-.032-1.43-.707-2.422-1.63-2.974a.938.938 0 0 0 .22-.606v-2.54h-.015a.951.951 0 0 0-.465-.95m-23.619.825l10.99-6.35c.329-.19.73-.192 1.064-.006l10.994 6.356l-11 6.36l-.005.003c-.318.186-.72.186-1.038 0zm-.351 3.612l10.85 6.273c.63.37 1.42.37 2.05 0l10.84-6.267l.22.127c.63.37.63 1.28 0 1.65l-11.07 6.4c-.63.37-1.42.37-2.05 0L3.9 15.89a.956.956 0 0 1 0-1.65zm.201 5.922a3.9 3.9 0 0 0 1.659.181c.53-.06 1.03.22 1.26.7C8 22.5 9.83 23.1 11.4 22.7c.52-.13 1.06.07 1.34.51a3.55 3.55 0 0 0 3 2.14h.01c.08.01.16.01.25.01h.02c.08 0 .16 0 .25-.01h.01a3.55 3.55 0 0 0 3-2.14c.28-.44.82-.64 1.34-.51c1.56.4 3.4-.2 4.15-1.79c.23-.48.73-.76 1.26-.7a3.898 3.898 0 0 0 1.592-.16l-.945.547A5.48 5.48 0 0 1 24.08 24a6.505 6.505 0 0 1-4.563.736L17.02 26.18c-.63.37-1.42.37-2.05 0l-2.495-1.442A6.505 6.505 0 0 1 7.92 24a5.48 5.48 0 0 1-2.596-3.396z"
      ></path>
    </svg>
  );
}
...
const AdminMenuBar = () => {
  ...
  const data = [
    {
      name: "Burger",
      img: <Burger className="iconadmin" />,
    },
    {
      name: "Sandwich",
      img: <Sandwich className="iconadmin" />,
    },
    {
      name: "Pasta",
      img: <Pasta className="iconadmin" />,
    },
    {
      name: "Pizza",
      img: <Pizza className="iconadmin" />,
    },
    {
      name: "Snacks",
      img: <Snacks className="iconadmin" />,
    },
    {
      name: "Beverages",
      img: <Beverages className="iconadmin" />,
    },
  ];
  ...
  return (
    <>
      <h3
        onClick={() => handelClickFood("all")}
        className="text-black text-xl bg-[#ffd0b9] rounded-md h-max w-max px-4 py-1 cursor-pointer mx-4"
      >
        All
      </h3>
      ...
      <div className="flex flex-wrap gap-2">
        {category?.map((index, i) => (
          <div
            onClick={() => handelClickFood(index)}
            className="menu-item text-xs flex flex-col items-center justify-center  bg-[#2222221c] rounded-md"
          >
            {index?.img}
            <h3 className="text-black text-xl px-4 py-1">{index}</h3>
          </div>
        ))}
      </div>
      <div className="flex flex-col text-xl items-center mx-4 justify-center cursor-pointer bg-[#ffd0b9] rounded-md h-max w-max px-4 py-1    ">
